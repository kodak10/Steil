        ...
        <div class="col-lg-10  m-auto">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="col-lg-6">
                        <h5 class="p-3">
                            LISTE DES CATEGORIES D'ENGIN
                        </h5>
                    </div>
                    <div class="col-lg-6">
                        <a href="{{route('categorie_engin.create')}}" class="btn btn-primary w-100">Ajouter une Catégorie</a>
                        ...
                        <div class="w-100">
                            <table class="table table-striped" id="liste_categorie_engin" style="width:100%">
                                ...
                                <tbody class="text-center">
                                    ...
                                    @foreach($categories_engins as $categories_engin)
                                        <?php $i++; ?>
                                        <tr>
                                            <td>{{$i}}</td>
                                            <td>{{ $categories_engin->nom }}</td>
                                            <td class="text-center d-flex justify-content-center" >
                                                ...
                                                <form
                                                    ...
                                                    method="POST"
                                                    action="{{ route('categorie_engin.destroy', $categories_engin->id) }}"
